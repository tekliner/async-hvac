...
from async_hvac import aws_utils, exceptions, adapters, utils, api
from async_hvac.constants.client import DEPRECATED_PROPERTIES
...
class AsyncClient(object):
    ...
    async def key_status(self):
        ...
        :rtype: dict
        """
        return (await self.sys.get_encryption_key_status())['data']
    ...
    async def get_policy(self, name, parse=False):
        ...
        """
        try:
            policy = (await self.sys.read_policy(name=name))['data']['rules']
        except exceptions.InvalidPath:
            return None
    ...
    async def renew_token(self, token=None, increment=None, wrap_ttl=None):
        ...
        if token is not None:
            params['token'] = token
            return await (await self._adapter.post('/v1/auth/token/renew', json=params, wrap_ttl=wrap_ttl)).json()
        else:
    ...
    async def list_userpass(self, mount_point='userpass'):
        ...
        """
        try:
            return await (await self._adapter.get('/v1/auth/{}/users'.format(mount_point), params={'list': True})).json()
        except exceptions.InvalidPath:
            return None
    ...
    async def read_userpass(self, username, mount_point='userpass'):
        ...
        :rtype:
        """
        return await (await self._adapter.get('/v1/auth/{}/users/{}'.format(mount_point, username))).json()
    ...
    async def get_vault_ec2_client_configuration(self, mount_point='aws-ec2'):
        ...
        :rtype:
        """
        return await (await self._adapter.get('/v1/auth/{0}/config/client'.format(mount_point))).json()
    ...
    async def get_vault_ec2_certificate_configuration(self, cert_name, mount_point='aws-ec2'):
        ...
        :rtype:
        """
        return await (await self._adapter.get('/v1/auth/{0}/config/certificate/{1}'.format(mount_point, cert_name))).json()
    ...
    async def list_vault_ec2_certificate_configurations(self, mount_point='aws-ec2'):
        ...
        """
        params = {'list': True}
        return await (await self._adapter.get('/v1/auth/{0}/config/certificates'.format(mount_point), params=params)).json()
    ...
    async def get_ec2_role(self, role, mount_point='aws-ec2'):
        ...
        :rtype:
        """
        return await (await self._adapter.get('/v1/auth/{0}/role/{1}'.format(mount_point, role))).json()
    ...
    async def list_ec2_roles(self, mount_point='aws-ec2'):
        ...
        """
        try:
            return await (await self._adapter.get('/v1/auth/{0}/roles'.format(mount_point), params={'list': True})).json()
        except exceptions.InvalidPath:
            return None
    ...
    async def list_roles(self, mount_point='approle'):
        ...
        return await (await self._adapter.get('/v1/auth/{0}/role?list=true'.format(mount_point))).json()
    ...
    async def get_role_id(self, role_name, mount_point='approle'):
        ...
        return (await (await self._adapter.get(url)).json())['data']['role_id']
    ...
    async def get_role_secret_id(self, role_name, secret_id, mount_point='approle'):
        ...
        return await (await self._adapter.post(url, json=params)).json()
    ...
    async def list_role_secrets(self, role_name, mount_point='approle'):
        ...
        return await (await self._adapter.list(url)).json()
    ...
    async def get_kubernetes_configuration(self, mount_point='kubernetes'):
        ...
        url = '/v1/auth/{0}/config'.format(mount_point)
        return await (await self._adapter.get(url)).json()
    ...
    async def cancel_generate_root(self):
        return (await self.sys.cancel_root_generation()).status == 204
