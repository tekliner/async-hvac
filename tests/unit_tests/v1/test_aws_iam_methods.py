...
class TestAwsIamMethods(TestCase):
    ...
    @mock.patch('async_hvac.aws_utils.datetime')
    @mock.patch('async_hvac.v1.AsyncClient.login', side_effect=login)
    async def test_auth_aws_iam(self, login_mock, datetime_mock):
